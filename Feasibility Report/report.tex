...
User will able to change the texture of walls and also modify the walls color by changing the paint color of walls.  User will able to change the tiles and marble designs of floor.
...
It is difficult for us to complete the proposed  system along with daily routine of work. So, it will be a challenge for us to complete it  in short period of time.
...
author = {So, Clifford and Baciu, George and Sun, Hanqiu},
year = {1998},
month = {01},
pages = {17-23},
title = {Reconstruction of 3D virtual buildings from 2D architectural floor plans},
doi = {10.1145/293701.293704}
}

 
\bibitem{ImageP} 
Image processing of 2D floor plan. [online] Available at: https://stackoverflow.com/questions/29471866/creating
-a-3d-map-with-2d-depth-images-in-processing

\bibitem{research} 
@article{article,
author = {Gimenez, Lucile and Robert, Sylvain and Suard, Frédéric and Zreik, Khaldoun},
year = {2016},
month = {03},
pages = {48-56},
title = {Automatic reconstruction of 3D building models from scanned 2D floor plans},
volume = {63},
...
Evaluation of project scope. [online] Available at: https://www.brighthubpm.com/project-planning/57950-example-
and-evaluation-of-project-scope-statements/

\bibitem{TechFeas} 
Technical Feasibility. [online] Available at: https://www.brighthubpm.com/project-planning/57950-example-and-
evaluation-of-project-scope-statements/

\bibitem{econFeas} 
Economic Feasibility. [online] Available at: https://www.quora.com/What-does-economic-feasibility-mean

\bibitem{sketchup} 
Existing System SketchUp. [online] Available at: https://www.sketchup.com/

\bibitem{unity} 
3D game engine Unity3D. [online] Available at: https://unity.com/


\bibitem{freecad} 
FreeCAD Pros and Cons. [online] Available at: http://d32l.com/blog/pros-and-cons-of-free-cad-services/

\bibitem{Irrlicht} 
3D graphics engine Irrlicht. [online] Available at: http://irrlicht.sourceforge.net/

\bibitem{limitation} 
3D modelling limitations. [online] Available at: https://projectmanagementlearning.com/what-are-the-
limitations-of-project-management.html

\bibitem{chall}  Challenges in project. [online] Available at: https://www.nap.edu/read/22121/chapter/
\end{thebibliography}
\end{document}